...
public class ControllerTest {
    ...
    public void setup() {
        ...
        apple = new FoodItem("Apple", 50, 10, 0, 0);
        banana = new FoodItem("Banana", 90, 20, 0, 0);
        tofu = new FoodItem("Tofu", 100, 30, 5, 5);
    }
    ...
    public void testSuggestFoodSwap() {
        ...
        FoodItem apple = new FoodItem("Apple", 95, 0.5, 0.3, 25);
        FoodItem chicken = new FoodItem("Chicken Breast", 165, 31.0, 3.6, 0);
        FoodItem rice = new FoodItem("White Rice", 200, 4.0, 0.4, 45);
    ...
    // UC8: View Deficiency Analysis (vs Canada Food Guide)
    @Test
